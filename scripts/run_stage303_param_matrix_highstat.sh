...
OUT="${STAGE303_OUT_DIR:-$ROOT/repro/stage303_param_matrix_highstat}"
RAW="$OUT/raw"
JOBS="${JOBS:-$(nproc)}"
PERF_RUNS="${STAGE303_PERF_RUNS:-5}"
PERF_REPS="${STAGE303_PERF_REPS:-1}"
NOISE_TRIALS="${STAGE303_NOISE_TRIALS:-5}"
PARAM_VALUE="${PARAM:-SET_4_5_2048}"
FFT_LIB_VALUE="${FFT_LIB:-spqlios_avx512}"
R_VALUE="${STAGE303_R:-4}"
