...
RAW="$ROOT/repro/stage274_sub_a_fused_materialization_smoke/raw"
JOBS="${JOBS:-$(nproc)}"
...
run_case suba_fused_from_dft_add include_zero true false SAB_PVW_SUBA_FUSED_FROM_DFT_ADD=true
run_case suba_fused_from_dft_add ternary false true SAB_PVW_SUBA_FUSED_FROM_DFT_ADD=true
