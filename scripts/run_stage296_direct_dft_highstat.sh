...
OUT="${STAGE296_OUT_DIR:-$ROOT/repro/stage296_direct_dft_highstat}"
RAW="$OUT/raw"
JOBS="${JOBS:-$(nproc)}"
PERF_RUNS="${STAGE296_PERF_RUNS:-10}"
PERF_REPS="${STAGE296_PERF_REPS:-1}"
NOISE_TRIALS="${STAGE296_NOISE_TRIALS:-10}"
PARAM_VALUE="${PARAM:-SET_2_3_2048}"
FFT_LIB_VALUE="${FFT_LIB:-spqlios_avx512}"
R_VALUE="${STAGE296_R:-4}"
