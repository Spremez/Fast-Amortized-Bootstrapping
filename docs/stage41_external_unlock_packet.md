...
|---|---|---|---|---|
| S41-FULLTEXT-INTAKE | WAIT_EXTERNAL_FULLTEXT | external=MISSING; stage38=BLOCKED_FULLTEXT_MISSING; audit_A8b=MISSING_OPTIONAL_EXTERNAL_EVIDENCE | `FAB686_FULLTEXT_PATH=/path/to/2025_686.pdf bash scripts/run_stage38_fulltext_review_gate.sh` | Map protocol stages, complexity formulas, noise/security assumptions, and PVW-SAB delta to concrete page or section anchors. |
...
- `S41-FINAL-RECHECK`: Keep SCOPED_ENGINEERING_CHAIN_READY__STRONGER_CLAIMS_BLOCKED until all stronger-claim rows have direct evidence.
