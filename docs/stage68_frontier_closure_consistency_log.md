...
|---|---|---|---|
| stage68_stage42_label | PASS | repro/stage42_evidence_closure_audit.csv | Stage 19-68 control-plane closure is internally closed: core Stage 19-62 scoped evidence chain plus Stage64A post-variant refresh, Stage65A optional negative variant, Stage66A post-variant final recheck, Stage67 final-recheck Stage66A integration, and Stage68 frontier/closure consistency; stronger claims remain blocked |
| stage68_stage51_g6 | PASS | repro/stage51_goal_completion_frontier.csv | status=LOCAL_READY; interpretation=Stage42 closure currently verifies the Stage19-68 evidence chain plus Stage64A post-variant refresh and Stage65A optional negative variant and Stage66A post-variant final recheck and Stage67 final-recheck Stage66A integration and preserves stronger-claim blockers. |
| stage68_stage57_scope_label | PASS | repro/stage57_scope_label_audit.csv | latest_stage=68; expected_label=Stage 19-68 |
...
| stage68_decision | PASS_FRONTIER_CLOSURE_CONSISTENCY | repro/stage68_frontier_closure_consistency.csv | Stage42, Stage51 G6, Stage57, and Stage59 are consistent after Stage67 |
