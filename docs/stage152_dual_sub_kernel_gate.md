...
| stage152_local_perf | PASS | mean_speedup;min_speedup | 1.166506;1.086011 | Repeated local sub-kernel speedup must be large enough to matter under the Stage151 sub-share. |  |
| stage152_predicted_body_impact | PASS | amdahl_body_speedup | 1.022215 | Predicted body impact uses the current r=6 cmux_sub/body share, not the whole SAB claim. |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 6 | 2048 | 20000 | 5 | 163722.000 | 140318.000 | 1.166506 | 1.086011 | 1.296950 | 7926754499936684809 | 7926754499936684809 | PASS | 1.022215 | 0.152252 | PASS_STAGE152_DUAL_SUB_LOCAL_POSITIVE_INTEGRATION_CANDIDATE |

## Interpretation

The isolated dual-sub mean/min speedup is `1.166506`/`1.086011` and the predicted body speedup is `1.022215`. This is only a local gate; complete SAB `T_bootstrap/r` remains unclaimed until an integration stage passes.
