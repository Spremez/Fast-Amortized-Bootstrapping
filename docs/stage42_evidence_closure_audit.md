...
| S42-CLOSURE-MANIFEST-HASHES | PASS | reproducibility | repro/stage42_evidence_closure_manifest.csv | 24 post-freeze control artifacts match recorded SHA-256 hashes |
