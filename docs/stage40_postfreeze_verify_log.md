...
|---|---|---|---|
| verification_input_commit | 60658d9 | git rev-parse --short HEAD | Commit checked before writing verifier output artifacts. |
...
| freeze_manifest_hashes | PASS | repro/stage40_final_freeze_manifest.csv | all manifest hashes match |
