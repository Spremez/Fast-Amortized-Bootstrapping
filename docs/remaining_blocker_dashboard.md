...
| CB7 | final_A8b=MISSING_OPTIONAL_EXTERNAL_EVIDENCE; cb7=BLOCKED_EXTERNAL_FULLTEXT; stage44_fulltext=BLOCKED; related_fulltext=BLOCKED_FULLTEXT; external_fulltext=MISSING | The 2025/686 full text is not registered or accessible through current direct routes. | `FAB686_FULLTEXT_PATH=/path/to/2025_686.pdf bash scripts/run_stage38_fulltext_review_gate.sh` | Do not cite theorem, algorithm, table, figure, or experiment numbers from 2025/686 until full text is supplied and reviewed. |
