...
| item | status | detail |
|---|---|---|
| freeze_input_commit | 73748fd | Commit state observed before writing Stage 40 artifacts. The artifact commit is the git commit that contains these generated files. |
