...
| item | status | detail |
|---|---|---|
| freeze_input_commit | 9972036 | Commit state observed before writing Stage 40 artifacts. The artifact commit is the git commit that contains these generated files. |
