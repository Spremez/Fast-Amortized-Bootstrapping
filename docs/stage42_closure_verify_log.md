...
|---|---|---|---|
| verification_input_commit | 7fa1377 | git rev-parse --short HEAD | Commit checked before writing verifier output artifacts. |
| worktree_clean_before_outputs | FAIL_DIRTY | git status --short --untracked-files=all | M docs/current_codex_goal_sab_completion.md; M docs/goal_sab_max_acceleration.md; M docs/roadmap_stage19_plus.md; M docs/stage42_evidence_closure_audit.md; M hypotheses/hypothesis_register.yaml; M repro/artifact_manifest.md; M repro/reproduction_checklist.md; M repro/run_log.csv; M repro/stage42_evidence_closure_audit.csv; M repro/stage42_evidence_closure_manifest.csv; M scripts/build_stage42_evidence_closure_audit.py; M scripts/verify_stage42_closure.py; ?? docs/stage104_post_external_final_package.md; ?? experiments/stage104_post_external_final_package_plan.md; ?? repro/stage104_post_external_final_package/artifact_index.csv; ?? repro/stage104_post_external_final_package/claim_boundary.csv; ?? repro/stage104_post_external_final_package/evidence_bridge.csv; ?? repro/stage104_post_external_final_package/performance_claims.csv; ?? repro/stage104_post_external_final_package/reproduction_commands.csv; ?? repro/stage104_post_external_final_package/summary.csv; ?? scripts/build_stage104_post_external_final_package.py |
| final_audit_A9 | PASS | repro/final_goal_completion_audit.csv | SCOPED_ENGINEERING_CHAIN_READY__EXTERNAL_REVIEWED_STRONGER_CLAIMS_SCOPED |
...
| stage87_h14_backend_from_dft_add_preflight | PASS | repro/stage87_h14_backend_from_dft_add_preflight/summary.csv | Stage87 records H14 backend FromDFT-add as a one-run promotion candidate without promoting code |
| stage88_h14_backend_repeated_gates | PASS | repro/stage88_h14_backend_repeated_gates/summary.csv | Stage88 records H14 backend FromDFT-add as a repeated/noise/resource promotion candidate without promoting defaults |
| stage89_h14_promotion_policy | PASS | repro/stage89_h14_promotion_policy_integration/summary.csv | Stage89 promotes H14 backend FromDFT-add as the preferred explicit r=6 path while defaults remain unchanged |
| stage90_external_claim_unlock | PASS | repro/stage90_external_claim_unlock/summary.csv | Stage90 records the external-claim probe and preserves native-perf/full-text/novelty blockers |
| stage91_final_package | PASS | repro/stage91_final_package/summary.csv | Stage91 freezes the scoped SAB optimization package while preserving stronger-claim blockers |
| stage92_external_unlock_execution | PASS | repro/stage92_external_unlock_execution/summary.csv | Stage92 records executable external unlock lanes while preserving stronger-claim blockers |
| stage93_external_lane_attempt | PASS | repro/stage93_external_lane_attempt/summary.csv | Stage93 records current external lane attempts while preserving stronger-claim blockers |
| stage94_local_frontier_audit | PASS | repro/stage94_local_frontier_audit/summary.csv | Stage94 records no justified new local hot-path candidate under current evidence |
| stage95_public_source_reprobe | PASS | repro/stage95_public_source_reprobe/summary.csv | Stage95 refreshes public source routes while preserving full-text/claim blockers |
| stage96_upstream_delta_audit | PASS | repro/stage96_upstream_delta_audit/summary.csv | Stage96 records upstream/local provenance and default-false flag guards |
| stage97_source_delta_guard | PASS | repro/stage97_source_delta_guard/summary.csv | Stage97 records source-delta isolation, default-false flags, and scalar/default smoke guards |
| stage98_current_smoke_refresh | PASS | repro/stage98_current_smoke_refresh/summary.csv | Stage98 current-head smoke refresh passes scalar/default, active PVW target, backend PVW target, and scalar ternary checks |
| stage99_external_blocker_reprobe | PASS | repro/stage99_external_blocker_reprobe/summary.csv | Stage99 records post-Stage98 external blocker reprobe and full-text review-required state |
| stage100_fulltext_anchor_prefill | PASS | repro/stage100_fulltext_anchor_prefill/summary.csv | Stage100 records candidate-only 2025/686 source anchors while preserving manual review requirements |
| stage104_post_external_final_package | PASS | repro/stage104_post_external_final_package/summary.csv | Stage104 refreshes the post-external final scoped package |
...
| stage42_verify_decision | FAIL_STAGE42_VERIFY | repro/stage42_closure_verify/summary.csv | Inspect failing checks before relying on Stage42 closure evidence. |

## Decision

Inspect failing checks before relying on Stage42 closure evidence.
