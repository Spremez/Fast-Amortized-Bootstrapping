...
|---|---|---|---|
| verification_input_commit | f2c3bce | git rev-parse --short HEAD | Commit checked before writing verifier output artifacts. |
...
| stage105_goal_completion_audit | PASS | repro/stage105_goal_completion_audit/summary.csv | Stage105 proves scoped goal completion and preserves stronger claim boundaries |
