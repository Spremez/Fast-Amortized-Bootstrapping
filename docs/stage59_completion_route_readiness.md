...
| S59-R7-FINAL-PAPER-PACKAGE | final freeze | paper/release claim package | SCOPED_FINAL_PACKAGE_READY_STRONGER_BLOCKED | Use Stage92 lane commands for external evidence; rerun Stage90/91/92/93 after source, backend, external-evidence, or claim-scope changes. |
