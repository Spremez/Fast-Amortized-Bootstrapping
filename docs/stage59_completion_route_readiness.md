...
| S59-R6-OPTIONAL-VARIANTS | optional local expansion | future algorithmic variants | READY_OPTIONAL_LOCAL_TRIAGE | Stage69 records no unblocked local variant under current evidence; unlock native perf/full text or introduce a new falsifiable hypothesis before new code work. |
