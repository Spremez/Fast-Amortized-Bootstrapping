...
| S59-R7-FINAL-PAPER-PACKAGE | final freeze | paper/release claim package | SCOPED_FINAL_PACKAGE_READY_STRONGER_BLOCKED | Keep the package scoped; rerun Stage90/91 after source, backend, external-evidence, or claim-scope changes. |
