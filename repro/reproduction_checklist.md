...
- [x] Candidate D historical erratum: the old Task 9 command is
  ...
  `python scripts/run_candidate_d_admission.py --input-commit c8221ad0fcd8413753ca4c3072f49460972de454 --controller-commit 8a953a54b8799089d2e7fef6d3951581b4cf8fd4 --run-date 2026-07-21 --execution-platform "Windows-PowerShell; CPython-3.12; evidence-controller-only; no-performance-claim"`. Current verified apply command: `python scripts/apply_candidate_d_admission.py --input-commit c8221ad0fcd8413753ca4c3072f49460972de454 --controller-commit 8a953a54b8799089d2e7fef6d3951581b4cf8fd4 --run-date 2026-07-21 --execution-platform "Windows-PowerShell; CPython-3.12; evidence-controller-only; no-performance-claim"`.
