...
#define __BENCH_LINE(l, f, CODE) MEASURE_TIME((char*)"N " #l, 1, (char*)"Benchmark " #f " line " #l, CODE)
#define _BENCH_LINE(l, f, CODE) __BENCH_LINE(l, f, CODE)
#define BENCH_LINE(CODE) _BENCH_LINE(__LINE__, __FILE__, CODE)
